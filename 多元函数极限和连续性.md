...
同样有定义:设$(X,d)$和$(X',d')$都是距离空间,如果$\forall \varepsilon >0,\exists \delta >0$,使得只要$x \in \Omega,0< d(x,a) < \delta$就有$d'(f(x),A) < \varepsilon$,那么我们就说：当ｘ沿集合$\Omega$趋于ａ时，映射$f(x)$以Ａ为极限．
